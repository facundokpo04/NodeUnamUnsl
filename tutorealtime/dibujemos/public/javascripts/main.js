$(function () {
  if ( ! ( 'getContext' in document.createElement('canvas') ) ) { 
    ...
    var id = Math.random($.now()*Math.random());
    ...
    //abrimos el socket
    var socket = io.connect('htpp://localhost');
   ...
   */
   function moveHandler(data){
        ...
        // le damos un cursor a cada usuario nuestro
            cursor[data.id] = $('<div class="cursor">').appendTo('#cursors');
    ...
    function drawLine(fromx, fromy, tox, toy, color){
        ctx.beginPath(); // create a new empty path
